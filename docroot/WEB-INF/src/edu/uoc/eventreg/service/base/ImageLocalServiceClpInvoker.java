...
public class ImageLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return ImageLocalServiceUtil.addImage((edu.uoc.eventreg.model.Image)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return ImageLocalServiceUtil.deleteImage((edu.uoc.eventreg.model.Image)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return ImageLocalServiceUtil.updateImage((edu.uoc.eventreg.model.Image)arguments[0]);
		}
		...
		if (_methodName64.equals(name) &&
			...
			return ImageLocalServiceUtil.findByEvent(((Long)arguments[0]).longValue());
		}
