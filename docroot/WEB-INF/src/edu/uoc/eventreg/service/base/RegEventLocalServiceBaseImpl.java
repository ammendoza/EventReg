...
import edu.uoc.eventreg.service.RegEventLocalService;
...
/**
 * Provides the base implementation for the reg event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.uoc.eventreg.service.impl.RegEventLocalServiceImpl}.
 * </p>
 *
 * @author Ana Mendoza
 ...
 * @generated
 */
public abstract class RegEventLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements RegEventLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.uoc.eventreg.service.RegEventLocalServiceUtil} to access the reg event local service.
	 */
	...
	@Override
	public RegEvent addRegEvent(RegEvent regEvent) throws SystemException {
		regEvent.setNew(true);

		return regEventPersistence.update(regEvent);
	}
	 ...
	 */
	@Override
	public RegEvent createRegEvent(long id) {
		return regEventPersistence.create(id);
	}
	...
	@Override
	public RegEvent deleteRegEvent(long id)
		throws PortalException, SystemException {
		return regEventPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RegEvent deleteRegEvent(RegEvent regEvent) throws SystemException {
		return regEventPersistence.remove(regEvent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RegEvent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return regEventPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return regEventPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return regEventPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return regEventPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RegEvent fetchRegEvent(long id) throws SystemException {
		return regEventPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public RegEvent getRegEvent(long id)
		throws PortalException, SystemException {
		return regEventPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return regEventPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RegEvent> getRegEvents(int start, int end)
		throws SystemException {
		return regEventPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRegEventsCount() throws SystemException {
		return regEventPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RegEvent updateRegEvent(RegEvent regEvent) throws SystemException {
		return regEventPersistence.update(regEvent);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("edu.uoc.eventreg.model.RegEvent",
			regEventLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"edu.uoc.eventreg.model.RegEvent");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = regEventPersistence.getDataSource();
	...
	private RegEventLocalServiceClpInvoker _clpInvoker = new RegEventLocalServiceClpInvoker();
}