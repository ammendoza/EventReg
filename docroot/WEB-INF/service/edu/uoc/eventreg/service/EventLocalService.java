 ...
 * @see edu.uoc.eventreg.service.impl.EventLocalServiceImpl
 * @generated
 */
...
public interface EventLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventLocalServiceUtil} to access the event local service. Add custom service methods to {@link edu.uoc.eventreg.service.impl.EventLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public edu.uoc.eventreg.model.Event addEvent(
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.DELETE)
	public edu.uoc.eventreg.model.Event deleteEvent(
		edu.uoc.eventreg.model.Event event)
		throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.util.List<edu.uoc.eventreg.model.Event> getEvents(int start,
		int end) throws com.liferay.portal.kernel.exception.SystemException;
	...
	*/
	@com.liferay.portal.kernel.search.Indexable(type = IndexableType.REINDEX)
	public edu.uoc.eventreg.model.Event updateEvent(
		edu.uoc.eventreg.model.Event event)
		throws com.liferay.portal.kernel.exception.SystemException;
