...
public class EventLocalServiceClp implements EventLocalService {
	public EventLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName22 = "searchEventsCount";
	...
	public edu.uoc.eventreg.model.Event addEvent(
		...
		return (edu.uoc.eventreg.model.Event)ClpSerializer.translateOutput(returnObj);
	}
