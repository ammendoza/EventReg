...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"event-registration-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "event-registration-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(AttendeeClp.class.getName())) {
	...
	public static Object translateInputAttendee(BaseModel<?> oldModel) {
		AttendeeClp oldClpModel = (AttendeeClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getAttendeeRemoteModel();
	...
	public static Object translateInputEventOption(BaseModel<?> oldModel) {
		...
		BaseModel<?> newModel = oldClpModel.getEventOptionRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"edu.uoc.eventreg.model.impl.EventOptionImpl")) {
			return translateOutputEventOption(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("edu.uoc.eventreg.NoSuchAttendeeException")) {
	...
	public static Object translateOutputAttendee(BaseModel<?> oldModel) {
		AttendeeClp newModel = new AttendeeClp();
	...
	public static Object translateOutputEventOption(BaseModel<?> oldModel) {
		EventOptionClp newModel = new EventOptionClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setEventOptionRemoteModel(oldModel);
