...
/**
 * The persistence utility for the reg event service. This utility wraps {@link RegEventPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class RegEventUtil {
	 ...
	 */
	public static void clearCache(RegEvent regEvent) {
		getPersistence().clearCache(regEvent);
	}
	 ...
	 */
	public static List<RegEvent> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<RegEvent> findWithDynamicQuery(
	 ...
	 */
	public static RegEvent update(RegEvent regEvent) throws SystemException {
		return getPersistence().update(regEvent);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static RegEvent update(RegEvent regEvent,
		ServiceContext serviceContext) throws SystemException {
		return getPersistence().update(regEvent, serviceContext);
	}
	...
	*/
	public static void cacheResult(edu.uoc.eventreg.model.RegEvent regEvent) {
		getPersistence().cacheResult(regEvent);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(regEvents);
	}
	...
	*/
	public static edu.uoc.eventreg.model.RegEvent create(long id) {
	...
	*/
	public static edu.uoc.eventreg.model.RegEvent remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			edu.uoc.eventreg.NoSuchRegEventException {
		return getPersistence().remove(id);
	}

	public static edu.uoc.eventreg.model.RegEvent updateImpl(
		edu.uoc.eventreg.model.RegEvent regEvent)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(regEvent);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static edu.uoc.eventreg.model.RegEvent findByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			edu.uoc.eventreg.NoSuchRegEventException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static edu.uoc.eventreg.model.RegEvent fetchByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<edu.uoc.eventreg.model.RegEvent> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static RegEventPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (RegEventPersistence)PortletBeanLocatorUtil.locate(edu.uoc.eventreg.service.ClpSerializer.getServletContextName(),
					RegEventPersistence.class.getName());

			ReferenceRegistry.registerReference(RegEventUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(RegEventPersistence persistence) {
	}

	private static RegEventPersistence _persistence;
}