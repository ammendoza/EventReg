...
/**
 * Provides the local service interface for RegEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ana Mendoza
 * @see RegEventLocalServiceUtil
...
public interface RegEventLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RegEventLocalServiceUtil} to access the reg event local service. Add custom service methods to {@link edu.uoc.eventreg.service.impl.RegEventLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
