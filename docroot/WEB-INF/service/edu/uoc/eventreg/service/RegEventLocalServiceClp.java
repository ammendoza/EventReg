 ...
 * @generated
 */
public class RegEventLocalServiceClp implements RegEventLocalService {
	public RegEventLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public edu.uoc.eventreg.model.RegEvent addRegEvent(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(regEvent) });
		}
		catch (Throwable t) {
		...
		return (edu.uoc.eventreg.model.RegEvent)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<edu.uoc.eventreg.model.RegEvent> getRegEvents(
		...
		return (java.util.List<edu.uoc.eventreg.model.RegEvent>)ClpSerializer.translateOutput(returnObj);
	}
